...
.addAnswer(
    [ '*PRECIOS: 2024*\n\n',
     ...
     '🔹 Certificado de Salud Internacional (emitido por un veterinario registrado ante el ICA en ingles y español): *$160.000 COP*\n',
     '_El certificado de salud para Brasil o Argentina tiene un costo de $200.000 COP_\n',
     '🔹 Certificado Adicional (Anexo IV para Europa, Certificado de Rabia para USA, Anexo para Reino Unido o Israel): *$140.000 COP*\n',
     ...
     '_*El costo del domicilio para aplicación de vacunas o implantación de microchip puede variar dependiendo el barrio y la ciudad*_'
    ]
    )
